...
function App() {
  return (
    <>
      <div>
        <div className='flex w-full h-full scale-95 shadow-md shadow-black'>
        ...
        <div className='flex w-full h-screen flex-col'>
          <div className=' bg-gradient-to-tr from-pink-400 to-[#4169E1] h-[30vh] flex items-center'>
            <h1 className='text-6xl text-white uppercase text-center font-semibold p-4'>maximice Associates</h1>
          </div>
          <div className='bg-black h-[70vh] grid grid-cols-2 '>
            <div className='w-full justify-center flex flex-col p-4'>
              <h1 className=' text-white text-8xl font-semibold uppercase'>Who We Are.</h1>
        ...
        <div className='flex w-full flex-col justify-center m-auto items-center '>
          ...
          <div className=' bg-black h-[30vh] w-full flex items-center'>
            <h1 className='text-6xl text-white uppercase text-center font-semibold p-4 ml-4'>The Services we offer</h1>
          </div>

          {/* webdesign  */}

          <div className='grid grid-cols-2 w-full h-full scale-90'>
            <div className='flex flex-col justify-center w-full p-4'>
              {/* <div className='flex  w-full'> */}
              <img src={bird} className='w-[150px]' alt='' />
              {/* </div> */}
              <div className='flex justify-center w-full flex-col p-4'>
                <span className='uppercase text-9xl font-semibold '>Web</span>
                <span className='uppercase text-8xl font-semibold -mt-6'>development</span>
                <p className='text-gray-700 w-[500px]'>dfjksdfn ajsdnakdnfalk akfn alfkna fkna lfknalkfn alf l aknsf laskfn lakf nalk fnafk naf knaf lakf nalf knal kaalwinfsljfsdhvbisuelhgb nafnalk alif o lkns
                </p>
              </div>
            </div>
          ...
          <div className=' bg-black w-full h-full'>
            <div className='grid grid-cols-2 w-full h-screen bg-black scale-90'>



              <div className='text-white flex flex-col gap-8 justify-center items-center w-full h-full p-4'>
            ...
            <div className='h-screen grid grid-rows-2 p-6'>
              ...
              <div className='flex  w-full p-4 '>
                <div className='flex flex-col w-full justify-center '>
                  <h1 className='text-8xl font-semibold uppercase '>Digital</h1>
                  <h1 className='text-9xl font-semibold uppercase -mt-3 '>Marketing</h1>
                </div>
                <div className='w-[400px] flex-col flex justify-center '>
                  <img src={bird} className='w-[80px]' alt='' />
                  <p className='flex text-justify'>dsjdkfk kafjg akjgka jgsfb akjf kagfb eyughbvhcjiugf huj sjb jbKJ huegbb   urg urgi riu uih u uifhauh   afh vblkbj aiu iuf fiu uufhaauifhafh  sif ieofij vefi f if oifj nodfjoiej  oIF fnskDFoi  </p>
                </div>
          ...
          <div className='w-full h-full'>
            <div className='h-full bg-black'>
              <div className=' bg-black h-[30vh] w-full flex items-center'>
                <h1 className='text-6xl bg-gradient-to-tr from-pink-400 to-[#4169E1] text-white uppercase text-center font-semibold p-4 ml-4'>Our Previous work</h1>
              </div>

              <div className='h-full scale-95'>
                {/* <div className='flex text-white gap-2'> */}
                <Carousel className='p-2 border-none' infiniteLoop={3000} showArrows >
                  <div className='w-full h-full grid grid-cols-2 bg-black  '>
                    ...
                    <div className='flex flex-col justify-center items-center w-full h-full'>
                      <div>
                        ...
                        <h1 className='text-white text-4xl font-serif'>Interrio</h1>
                      </div>
                      <p className='text-gray-300 max-w-[300px] '>lorem shuashdbh hasduyda slorem asdd ja djasd ajd ajsdakjf hajdoegbs veyeifnhd sirnjdh ajejnaaefnf </p>
                    </div>
                  </div>

                  <div className='w-full h-full grid grid-cols-2 bg-black p-4 '>
                    <div className='flex justify-center  items-center w-full h-full p-4'>
                ...
                <div className='w-full h-full '>
                  <div>
                    <div className=' bg-black'>
                      <div className=' bg-black h-[30vh] w-full flex items-center'>
                        <h1 className='text-6xl  bg-gradient-to-tr from-pink-400 to-[#4169E1] text-white uppercase text-center font-semibold p-4 ml-8'>Get Connect with us</h1>
                      </div>
                    </div>
                ...
                <div className='w-full h-full  rounded-2xl  '>
                  <div className='grid grid-cols-2 w-full h-screen bg-slate-100  scale-95 '>
                    <div className='text-white flex flex-col justify-around'>
                      <div className='flex w-full flex-col items-center  '>
                        <h1 className='text-7xl font-bold text-center mt-2 text-gray-800 '>Innovate with us</h1>
                        <p className=' w-[500px] text-justify text-xl mt-2 text-gray-600'>Ready to take your business to next level? Contact us today to discuss your project & get a free consultation. We're here to answer any question you may have.</p>
                      </div>

                      <div className=''>
                        <h1 className='text-orange-500 text-6xl text-center uppercase'>Book Now</h1>
                        <h2 className='text-orange-500 text-5xl text-center uppercase'>Free consultation</h2>
                      </div>
                      <div>
                        <h1 className='text-gray-800 text-3xl text-center uppercase'>+91 9890845263</h1>
                        <p className='text-gray-800 text-3xl text-center '>businessatmaximice@gmail.com</p>
                      </div>
                    </div>
                    <div className='text-white w-full h-full flex flex-col justify-center items-center gap-4'>
                      <img src={business} className=' object-cover rounded-xl w-[200px]' alt='' />
                      ...
                      <span className='text-gray-800 text-xl'>Maximice Associates</span>
                    </div>
                  </div>
                ...
                <div className='w-full h-full flex justify-between text-white mt-10 gap-2 '>
                  <div className='flex justify-center w-full flex-col items-center p-4 bg-gradient-to-br from-blue-500 to-violet-600 '>
                    <span className='text-4xl font-semibold uppercase'>+12</span>
                    <h1 className='text-3xl font-semibold uppercase'>Web development</h1>
                  </div>
                  <div className='flex justify-center w-full flex-col items-center p-4 bg-gradient-to-br from-blue-500 to-violet-600'>
                    <span className='text-4xl font-semibold uppercase'>+15</span>
                    <h1 className='text-3xl font-semibold uppercase'>Logo Design</h1>
                  </div>
                  <div className='flex justify-center w-full flex-col items-center p-4 bg-gradient-to-br from-blue-500 to-violet-600'>
                    <span className='text-4xl font-semibold uppercase'>+02</span>
                    <h1 className='text-3xl font-semibold uppercase'>App Development</h1>
                  </div>
                </div>
              </div>
            </div>
